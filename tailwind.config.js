...
module.exports = {
  ...
  theme: {
    container: {
      // Standard Shadcn container config
      center: true,
      padding: "2rem",
      screens: {
        "2xl": "1400px",
    ...
    extend: {
      ...
      borderRadius: {
        // Standard Shadcn border radius config using CSS variable
        lg: "var(--radius)",
      ...
      fontWeight: {
        // User's custom font weights
        extralight: 200,
        light: 300,
      },
      fontSize: {
        // Further adjusted font size values (decreased again)
